...
for i = 1:n
    ...
    % save the connectome
    save(strcat(fc_dir, name, '_mean_fc_laplace.mat'), 'mean_fc');
    ...
    % save the connectome
    save(strcat(corr_dir, name, '_mean_fc_laplace.mat'), 'mean_fc');
    ...
    % save the connectome
    save(strcat(coh_dir, name, '_mean_fc_laplace.mat'), 'mean_fc');
end
