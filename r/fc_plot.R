...
# connectome plots
matrixPlot("../../csv/fc/PED_05.csv")
matrixPlot("../../csv/fc/PED_14.csv")
matrixPlot("../../csv/fc/PED_03.csv")
matrixPlot("../../csv/fc/PED_13.csv")
matrixPlot("../../csv/fc/PED_15.csv")
matrixPlot("../../csv/fc/PED_16.csv")
matrixPlot("../../csv/fc/PED_17.csv")
