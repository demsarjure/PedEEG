...
%% load the data
raw = pop_fileio(strcat('../../../raw_data/test/', subject, '/', subject, 'a.vhdr'), 'dataformat', 'auto');
raw.setname = 'raw';
...
%% use only 120 good
good_epochs = [2:7, 14:21, 24:55, 64:75, 90:133, 166:175, 242:249];
